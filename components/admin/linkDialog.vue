        ...
        <div class="modal-body">
            <form @submit.prevent="submit">
                ...
                <div class="mb-3">
                    ...
                    >
                    <p class="text-center">
                        <b v-if="model.greeting">{{ model.greeting }}<br /></b>С
                        большой радостью приглашаем вас на семейный праздник —
                        нашу свадьбу! Мы будем рады, если вы проведете этот
                        счастливый день с нами.
                    </p>
                </div>
                <button
                    v-if="model.greeting"
